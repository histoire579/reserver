    ...
    <div class="row mt">
      <div class="col-lg-12">
        <div class="content-panel">
          <h4><i class="fa fa-angle-right"></i> Avis</h4>
          {{-- <div class="row">
          ...
          <section id="no-more-tables">
            <table class="table table-bordered table-striped table-condensed cf" style="font-size: 18px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="numeric" data-title="Price"><a href="/administration/avis/show/{{$type->id}}">Déspprouver</a></td>
                  @else
                  <td class="numeric" data-title="Price"><a href="/administration/avis/edit/{{$type->id}}">Approuver</a></td>
                  @endif
                  
                  <td class="numeric" data-title="Change">
                    <form action="/administration/avis/destroy/{{$type->id}}" method="DELETE">
                      @csrf
                      @method('DELETE')
                      <a href="/administration/avis/destroy/{{$type->id}}" type="button" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o" style="color: red" aria-hidden="true"></i></a></td>
            ...
            <div style="text-align: right; margin: 15px">{{$avis->links()}}</div>
          </section>
        </div>
        <!-- /content-panel -->
      </div>

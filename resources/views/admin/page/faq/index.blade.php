      ...
      <div class="col-lg-12">
        <div class="content-panel">
          ...
          <div class="row">
             ...
             <div class="col-md-4 col-sm-4 mb"></div>
             <div class="col-md-4 col-sm-4 mb"><a style="float: right;margin-right: 100px" href="/administration/faq/add" type="button"  class="btn btn-default"><i class="fa fa-plus-square" style="color: #08367A" aria-hidden="true"></i> Nouveau</a></div>
          </div>
            ...
            <table class="table table-bordered table-striped table-condensed cf" style="font-size: 18px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="numeric" data-title="Price"><a href="/administration/faq/edit/{{$type->id}}"> <i class="fa fa-pencil" style="color: #08367A" aria-hidden="true"></i></a></td>

    ...
    <div class="row mt">
        <div class="col-lg-12">
          ...
          <div class="form-panel">
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.super-categorie.edit',$categorie->id)}}">
                @csrf
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="/administration/super-categorie" type="button" class="btn btn-danger">Annuler</a>
                  </div>
                </div>
              </form>
            </div>

            ...
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.about')}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <textarea class="form-control" name="description" id="description" placeholder="Votre description" rows="5" data-rule="required" data-msg="Votre description"></textarea>
                  </div>
                </div>

    ...
    <div class="row mt">
      <div class="col-lg-12">
        <div class="content-panel">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande-valide-search-date')}}">
                @csrf
            ...
            <div class="col-md-6 col-sm-6 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande-valide-search-interval-date')}}">
                @csrf
                <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande-valide-search')}}">
                @csrf
                <div class="form-group">
            ...
            <table class="table table-bordered table-striped table-condensed cf" style="font-size: 18px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="numeric" data-title="Price"><a href="{{route('administration.commande-valide.edit', ['order' => $type->id])}}" title="Modifier"> Détails</a></td>
                  <td class="numeric" data-title="Price"><a href="{{route('administration.commande-valide.invalider', ['order' => $type->id])}}" title="Modifier"> Invalider</a></td>
                  <td class="numeric" data-title="Price"><a href="{{route('administration.commande-valide.envoyer', ['order' => $type->id])}}" title="Modifier"> Envoyer</a></td>  
                </tr>                   
                @endforeach
              </tbody>
            </table>

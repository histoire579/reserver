    ...
    <div class="row mt">
      <div class="col-lg-12">
        <div class="content-panel">
          <h4><i class="fa fa-angle-right"></i>Commande en cours</h4>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande-en-cours-search-date')}}">
                @csrf
            ...
            <div class="col-md-6 col-sm-6 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande-en-cours-search-interval-date')}}">
                @csrf
                <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande-en-cours-search')}}">
                @csrf
                <div class="form-group">
            ...
            <table class="table table-bordered table-striped table-condensed cf" style="font-size: 18px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="numeric" data-title="Price"><a href="{{route('administration.commande-en-cours.edit', ['order' => $type->id])}}" title="Modifier"> Détails</a></td>
                  <td class="numeric" data-title="Price"><a href="{{route('administration.commande-en-cours.valider', ['order' => $type->id])}}" title="Modifier"> Valider</a></td>
                  <td class="numeric" data-title="Price"><a href="{{route('administration.commande-en-cours.envoyer', ['order' => $type->id])}}" title="Modifier"> Envoyer</a></td>  
                </tr>                   
                @endforeach
              </tbody>
            </table>
